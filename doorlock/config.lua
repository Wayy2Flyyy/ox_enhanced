...
---Unused — the screen-space text prompt is disabled (only the in-world "E" key cap is shown).
Config.DrawTextUI = false

---Draw an ox_inventory-style "E" key cap floating at nearby doors.
---  unlocked → amber accent
---  locked   → blood accent
