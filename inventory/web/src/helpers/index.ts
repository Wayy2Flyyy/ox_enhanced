...
export const canPurchaseItem = (item: Slot, ox_inventory: { type: Inventory['type']; groups: Inventory['groups'] }) => {
...
export const isContainer = (ox_inventory: Inventory) => inventory.type === InventoryType.CONTAINER;
